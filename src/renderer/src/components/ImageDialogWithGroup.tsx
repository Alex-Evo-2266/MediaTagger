...
export const ImageDialogWithGroup: React.FC<IImageDialog> = ({
  name,
  onClose,
  filter,
  reload,
  ...
  const [currentImgName, setCurrentImgName] = useState<[string, string?]>([name, group])
